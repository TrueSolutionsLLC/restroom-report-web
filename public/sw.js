const CACHE="restroom-report-v4";
self.addEventListener("install",event=>event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(["/","/manifest.webmanifest","/favicon.png","/app-icon-192.png","/app-icon-512.png"]))));
